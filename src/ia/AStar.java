...
public class AStar {
	...
	public static List<Node> findPath(Word world, Vector2i start, Vector2i end){
		...
		while(openList.size() > 0) {
			...
			for(int i = 0; i < 9; i++) {
				...
				//System.out.println("width mundo: "+Word.WIDTH);
				Tile tile = Word.tiles[x+xi+((y+yi)*Word.WIDTH)];
				if(tile == null) continue;
				if(tile instanceof TileParede) continue;
				if(i == 0) {
